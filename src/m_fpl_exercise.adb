...
procedure M_FPL_EXERCISE is
   ...
   function F_CREATE_FLIGHT_PLAN
     (V_CALLSIGN : Q_FP_DATA.T_CALLSIGN; V_SSR : Q_FP_DATA.T_SSR)
      return Q_FP_DATA.T_FLIGHT_PLAN
   is
...
begin
   Q_FP_DATA.Q_MANAGER.P_ADD_FLIGHT_PLAN
     (F_CREATE_FLIGHT_PLAN (V_CALLSIGN => "ABC1234", V_SSR => "1234"));
   Q_FP_DATA.Q_MANAGER.P_ADD_FLIGHT_PLAN
     (F_CREATE_FLIGHT_PLAN (V_CALLSIGN => "XYZ4567", V_SSR => "7600"));
   Q_FP_DATA.Q_MANAGER.P_ADD_FLIGHT_PLAN
     (F_CREATE_FLIGHT_PLAN (V_CALLSIGN => "LMN7890", V_SSR => "5467"));
   Q_FP_DATA.Q_MANAGER.P_ADD_FLIGHT_PLAN
     (F_CREATE_FLIGHT_PLAN (V_CALLSIGN => "DEF0123", V_SSR => "3643"));
   Q_FP_DATA.Q_MANAGER.P_ADD_FLIGHT_PLAN
     (F_CREATE_FLIGHT_PLAN (V_CALLSIGN => "GHI3456", V_SSR => "7700"));
